    ...
    it('should create a new pipeline', () => {
      ...
      return adminHelper.admin.config.pipelines
        ...
        .then(() => {
          ...
          assert.deepStrictEqual(cfg.pipelines.test.apiEndpoints, testPipeline.apiEndpoints);
          assert.deepStrictEqual(cfg.pipelines.test.policies, testPipeline.policies);
  ...
  describe('when pipelines defined', () => {
    ...
    it('should create a new pipeline', () => {
      ...
      return adminHelper.admin.config.pipelines
        ...
        .then(() => {
          ...
          const cfg = yaml.load(data);
          assert.deepStrictEqual(cfg.pipelines.test.apiEndpoints, testPipeline.apiEndpoints);
          assert.deepStrictEqual(cfg.pipelines.example.apiEndpoints, ['example']);
          assert.deepStrictEqual(cfg.pipelines.hello.apiEndpoints, ['hello']);
          assert(cfg.pipelines.test.customId);
        });
    });
    it('should update existing pipeline', () => {
      ...
      return adminHelper.admin.config.pipelines
        ...
        .then(() => {
          const data = fs.readFileSync(config.gatewayConfigPath, 'utf8');
          const cfg = yaml.load(data);
          assert.deepStrictEqual(cfg.pipelines.example.apiEndpoints, testPipeline.apiEndpoints);
    ...
    it('should show existing pipeline', () => {
      return adminHelper.admin.config.pipelines
        .info('example')
        .then((endpoint) => {
          assert.deepStrictEqual(endpoint.apiEndpoints, ['example']);
        });
    });
    it('should list all pipelines', () => {
      return adminHelper.admin.config.pipelines
        .list()
        .then((pipelines) => {
          assert.deepStrictEqual(pipelines.example.apiEndpoints, ['example']);
          assert.deepStrictEqual(pipelines.hello.apiEndpoints, ['hello']);
