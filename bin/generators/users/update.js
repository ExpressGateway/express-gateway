...
module.exports = class extends eg.Generator {
  ...
  _update () {
    ...
    return request
      .get('http://localhost:' + this.eg.config.gatewayConfig.admin.port + '/users/' + argv.user_id)
      .then(res => {
        ...
        return this.prompt(questions)
          .then(answers => {
            ...
            return request
              .put('http://localhost:' + this.eg.config.gatewayConfig.admin.port + '/users/' + argv.user_id)
              .send(user)
              .then(res => {
