      ...
      const fn = (req, res, next) => {
        if (conditionConfig) {
          if (condition instanceof Promise) {
            return condition.then(condFn => evaluateConditionResult(condFn(req), { req, res, policyName, policyMiddleware, next }));
          }
          return evaluateConditionResult(condition(req), { req, res, policyName, policyMiddleware, next });
        }
