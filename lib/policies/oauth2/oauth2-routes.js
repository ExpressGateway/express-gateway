...
module.exports = function (app, config) {
  ...
  const urlPrefix = config.systemConfig.oauth2['oauth2-url-prefix'] || '';
  app.get(`${urlPrefix}/login`, site.loginForm);
  app.post(`${urlPrefix}/login`, middlewares, site.login);
  app.get(`${urlPrefix}/logout`, site.logout);
