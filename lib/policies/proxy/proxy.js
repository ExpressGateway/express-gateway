...
module.exports = function (params, config) {
  ...
  if (endpoint.proxyOptions) {
    const clonedProxyOptions = clone(endpoint.proxyOptions);
    Object.assign(proxyOptions, clonedProxyOptions);
    ...
    const clonedProxyOptions = clone(params.proxyOptions);
    Object.assign(proxyOptions, clonedProxyOptions);
  }

  const clonedProxyOptions = clone(params);
  Object.assign(proxyOptions, clonedProxyOptions);
