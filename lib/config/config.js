...
class Config {
  constructor () {
    ...
    this.gatewayValidator = schemas.register('config', 'gateway.config', require('./gateway.config.json'));
    this.systemValidator = schemas.register('config', 'system.config', require('./system.config.json'));
  }
  ...
  loadSystemConfig () {
    ...
    const { isValid, error } = this.systemValidator(this.systemConfig);
  ...
  loadGatewayConfig () {
    ...
    const { isValid, error } = this.gatewayValidator(this.gatewayConfig);
